...
require(["vs/editor/editor.main"], function () {
  ...
  document
    .getElementById("format-edit-1")
    .addEventListener("click", formatJson1);
  ...
  document
    .getElementById("font-zoom-out")
    .addEventListener("click", fontZoomOut);
  ...
  document
    .getElementById("font-zoom-reset")
    .addEventListener("click", fontZoomReset);
  ...
  function sortJson1() {
    var jsonString = validateJson(editor1.getValue());
    var isValidJsonString = isJsonString(jsonString);
    if (isValidJsonString) {
      ...
      alert(
        "Invalid Json in Editor 1. Please fix the issues and try again with a valid JSON"
      );
    }
  }
  ...
  var editor2 = monaco.editor.create(document.getElementById("editor2"), {
    value: ['{ "stuff": { "that": [1,2,3], "isin": true, "json": "end"}}'].join(
      "\n"
    ),
    language: "json",
    tabSize: 2,
  ...
  document
    .getElementById("format-edit-2")
    .addEventListener("click", formatJson2);
  ...
  function sortJson2() {
    ...
    if (isValidJsonString) {
      ...
      alert(
        "Invalid Json in Editor 2. Please fix the issues and try again with a valid JSON"
      );
    }
  }
  ...
  document
    .getElementById("refresh-diff")
    .addEventListener("click", switchToDiff);
  document
    .getElementById("compare-json")
    .addEventListener("click", switchToDiff);
  ...
  document
    .getElementById("previous-change")
    .addEventListener("click", previousDiff);
  ...
  function layout() {
    ...
    var REMAINING_HEIGHT =
      HEIGHT - TITLE_HEIGHT - FOOTER_HEIGHT - TABS_HEIGHT - FOOTER_HEIGHT;
    ...
    document.getElementById("diff-editor").style.height =
      REMAINING_HEIGHT + "px";
    document.getElementsByClassName("other-format-div")[0].style.width =
      WIDTH + "px";
