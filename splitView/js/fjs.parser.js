var fjs = typeof (fjs) === 'undefined' ? {} : fjs;
                ...
                for (; ;) {
                    ...
                    if (typeof s == "undefined" || !s.length || !s[0]) {
                        if (!j) {
                            ...
                            var A = "";
                            this.lexer.showPosition ? A = "Error on line " + (h + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + z.join(", ") : A = "Error on line " + (h + 1) + ": Unexpected " + (p == 1 ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(A, {
                    ...
                    if (s[0] instanceof Array && s.length > 1) throw new Error("Fix Errors: multiple actions possible at state: " + r + ", token: " + p);
                    switch (s[0]) {
                        case 1:
